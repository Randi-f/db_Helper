...
class TestController extends BaseController
{
    ...
    public function testCheckUserExist(){
        return UserService::checkUserExist(82);
    }
    public function testSendMailFailure(){
        return SendMail::sendMail("1059377785@qq.c","message");
    }
    ...
    public function hello111($name = 'ThinkPHP6')
    {
        return 'hello,' . $name;
    }
    ...
    public function testTableScroll(){
        return View::fetch("test/testTableScroll");
    }

    public function testMail(){
        SendMail::sendMail("199","test");
    }
    ...
    /**
     * @description: test Session function
     * @return {*}
     */    
    ...
    public function testSearchButton(){
        return View::fetch("test/testSearchButton");
    }
